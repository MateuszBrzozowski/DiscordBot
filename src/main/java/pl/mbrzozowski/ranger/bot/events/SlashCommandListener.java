...
public class SlashCommandListener extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (name.equals(ADD_ROLE_TO_RANGER.getName())) {
        ...
        } else if (name.equals(DAILY_STATS_SWITCH.getName())) {
            serverStatsService.dailyStatsSwitch(event);
            ...
            RandomTimeout randomTimeout = RandomTimeout.getInstance();
            randomTimeout.injectService(settingsService);
            randomTimeout.start(event);
